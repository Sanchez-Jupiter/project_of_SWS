...
const POTIONS_APPEAR_LENGTH = 10000;
...
const recover_potion = [ update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/green%20potion.png"), [0.15, 0.15]),
                        update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/green%20potion.png"), [0.15, 0.15]),
                        update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/green%20potion.png"), [0.15, 0.15]),
                        update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/green%20potion.png"), [0.15, 0.15]),
                        update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/green%20potion.png"), [0.15, 0.15])
                        ];
...
const player2 = [update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/1.png"),  size_of_player),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/2.png"), size_of_player),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/3.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/4.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/5.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/6.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/7.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/8.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/9.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/10.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/11.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/12.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/13.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/14.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/15.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/16.png"), size_of_player ),                
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/17.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/18.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/19.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/20.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/21.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/22.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/23.png"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/IssacL04/project_of_SWS_temp/main/24.png"), size_of_player )                
                ];
...
update_loop(game_state => {
    ...
    //--------------------------random falling potions--------------------------
    if(get_time() % 500 === 0){
        for(let i = 0; i < array_length(is_recover_potion_appear); i = i + 1){
            if(!is_recover_potion_appear[i]){
                update_position(recover_potion[i], [random_under_x(BOUNDRY_MAX - 10), 0]);
                is_recover_potion_appear[i] = true;
                recover_potion_appeartime[i] = get_time();
                break;
            }
        }
    }
    ...
    const present_time_recover_potion = get_time();
    for(let i = 0; i < array_length(recover_potion_appeartime); i = i + 1){
        //swords dispear check
        if(!is_recover_potion_appear[i]){
            continue;
        }
        if(present_time_recover_potion - recover_potion_appeartime[i] > POTIONS_APPEAR_LENGTH){
            update_position(recover_potion[i], [inf, inf]);
            is_recover_potion_appear[i] = false;
            continue;
        }
        update_rotation(recover_potion[i], (get_time() % 2 === 1) ? math_PI / 40 : -1 * math_PI / 40);
        //boundry check
        const recover_potion_posi_x = query_position(recover_potion[i])[0];
        const recover_potion_posi_y = query_position(recover_potion[i])[1];
        
        if( gameobjects_overlap(boundry[LEFT], recover_potion[i])){
            update_position(recover_potion[i], [recover_potion_posi_x + 10 * movement_dist, recover_potion_posi_y]);
        }
        else if( gameobjects_overlap(boundry[RIGHT], recover_potion[i])){
            update_position(recover_potion[i], [recover_potion_posi_x - 10 * movement_dist, recover_potion_posi_y]);
        }
        else if( gameobjects_overlap(boundry[UP], recover_potion[i])){
            update_position(recover_potion[i], [recover_potion_posi_x, recover_potion_posi_y + 10 * movement_dist]);
        }
        else if( gameobjects_overlap(boundry[DOWN], recover_potion[i])){
            update_position(recover_potion[i], [recover_potion_posi_x, recover_potion_posi_y - 10 * movement_dist]);
        }
        //gravity
        if(! is_borderline(barri, query_position(recover_potion[i]), 0)){
            if(query_position(recover_potion[i])[0] > 0 && query_position(recover_potion[i])[0] < 550 
            && query_position(recover_potion[i])[1] > 0 && query_position(recover_potion[i])[1] < 550){
                update_position(recover_potion[i], [query_position(recover_potion[i])[0], query_position(recover_potion[i])[1] + g]);
            }
        }
    }
    //
    ...
    //----------------------pick up recover potion check------------------------
    if(hp1 < origin_HP){
        for(let i = 0; i < array_length(is_recover_potion_appear); i = i + 1){
            if(gameobjects_overlap(recover_potion[i], player[cond])){
                update_position(recover_potion[i], [inf, inf]);
                is_recover_potion_appear[i] = false;
                hp1 = (hp1 + RECOVER_POTION_VALUE > origin_HP ? origin_HP : hp1 + RECOVER_POTION_VALUE);
            }
        }
    }
                ...
                if(with_sword[0]){
                    ...
                    for(let i = 0; i < array_length(is_bullet1_appear); i = i + 1){
                        if(!is_bullet1_appear[i]){
                            ...
                            update_position(bullets_towards_right1[i], [x + 30, y]);
                            break;
                        }
                    }
                    update_position(player[cond], [-inf, -inf]);
                ...
                if(with_sword[0]){
                    ...
                    for(let i = 0; i < array_length(bullets_towards_left1); i = i + 1){
                        if(!is_bullet1_appear[i]){
                            is_bullet1_appear[i] = true;
                            bullet1_dire[i] = LEFT;
                            update_position(bullets_towards_left1[i], [x -30, y ]);
                            break;
                        }
                    }
                    update_position(player[cond], [-inf, -inf]);
   ...
   if(! is_borderline(barri, query_position(player[cond]), 0)){
    ...
    //----------------------pick up potion check--------------------------------
    
    if(hp2 < origin_HP2){
        for(let i = 0; i < array_length(is_recover_potion_appear); i = i + 1){
            if(gameobjects_overlap(recover_potion[i], player2[cond2])){
                update_position(recover_potion[i], [inf, inf]);
                is_recover_potion_appear[i] = false;
                hp2 = (hp2 + RECOVER_POTION_VALUE > origin_HP2 ? origin_HP2 : hp2 + RECOVER_POTION_VALUE);
            }
        }
    }
    //--------------------------------------------------------------------------
                ...
                if(with_sword[1]){
                    ...
                    for(let i = 0; i < array_length(is_bullet2_appear); i = i + 1){
                        if(!is_bullet2_appear[i]){
                            ...
                            update_position(bullets_towards_right2[i], [x + 30, y]);
                            break;
                        }
                    }
                    update_position(player2[cond2], [-inf, -inf]);
                ...
                if(with_sword[1]){
                    ...
                    for(let i = 0; i < array_length(bullets_towards_left2); i = i + 1){
                        if(!is_bullet2_appear[i]){
                            is_bullet2_appear[i] = true;
                            bullet2_dire[i] = LEFT;
                            update_position(bullets_towards_left2[i], [x - 30, y ]);
                            break;
                        }
                    }
                    update_position(player2[cond2], [-inf, -inf]);
