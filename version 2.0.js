...
const guns = [update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun.jpg"), [0.5, 0.5]),
            update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun.jpg"), [0.5, 0.5]),
            update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun.jpg"), [0.5, 0.5]),
            update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun.jpg"), [0.5, 0.5])
            ];
...
const player = [update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/Screenshot_20230717_181659_com.huawei.hinote.png"),  size_of_player),
                ...
                update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun_left2.jpg"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun_left3.jpg"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun_right2.jpg"), size_of_player ),
                update_scale( create_sprite("https://raw.githubusercontent.com/Sanchez-Jupiter/project_of_SWS/main/gun_right3.jpg"), size_of_player ),
...
update_loop(game_state => {
   ...
   if (input_key_down("1") ) { // && get_time() - last_time_jump > 60 （another version）
   ...
   else if(input_key_down("2") && cond2 !== defense_right && cond2 !== defense_left){
       if(is_towards_right(cond2)){
           //cond = punch_right;
           if(check_barri(player2[cond2], barri)){
                if(is_beside_left(barri, query_position(player2[cond2]), 0) && (!is_borderline(barri, query_position(player2[cond2]), 0))){
   ...
   else if(defense_hp2 > 0 && input_key_down("3")){
       if(is_towards_right(cond2)){
           //cond = punch_right;
            if(check_barri(player2[cond2], barri)){
                if(is_beside_left(barri, query_position(player2[cond2]), 0) && (!is_borderline(barri, query_position(player2[cond2]), 0))){
